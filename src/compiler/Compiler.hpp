...
/**
 * @brief Singleton class responsible for compiling Theta source code into an Abstract Syntax Tree
 * (AST).
 */
namespace Theta {
    class Compiler {
    public:
         ...
         * @param isEmitTokens Toggles whether or not the lexer tokens should be output to the
         * console
        ...
        /**
         * @brief Builds the Abstract Syntax Tree (AST) for the Theta source code starting from the
         * specified file.
    ...
    private:
        /**
         * @brief Private constructor for Compiler. Initializes the compiler and discovers all
         * capsules in the source files.
         */
        Compiler() {
         ...
         *
         * Scans the current directory and subdirectories to find all `.th` files and extracts
         * capsule names.
         */
         ...
         *
         * Reads the content of the file and searches for the `capsule` keyword to identify the
         * capsule name.
         *
