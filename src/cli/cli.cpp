...
namespace Theta {
    ...
    private:
        static void printUsageInstructions() {
            ...
            cout << "  --emitTokens                   Emit the tokenized representation of the "
                    "source file produced by "
                    "the lexer."
                 << endl;
            cout << "  --emitAST                      Emit the Abstract Syntax Tree (AST) "
                    "representation produced by "
                    "the parser."
                 << endl;
            cout << "  --emitWAT                      Emit the WebAssembly Text format (WAT) "
                    "representation produced."
                 << endl;
            cout << "  --help                         Display this help message and exit." << endl;
            cout << "  --version                      Display the currently installed Theta "
                    "language version and exit."
                 << endl;
        }
        ...
        static bool validateOption(string option) {
            vector<string> validOptions = {"--version", "--help", "--emitTokens", "--emitAST", "--emitWAT", "-o"};
